...
---
# Power Comparison
#### *Assuming No Ties—Comparative (incl. "Plus" Versions)*

This document outlines the procedure of the comparative power analysis of Task 2016's algorithm, our new algorithm, and the public argorithm.
...
# save the plot data
save(plot_df, file = "comparison/no_ties/comp_crit_val_iso_data.Rda")
